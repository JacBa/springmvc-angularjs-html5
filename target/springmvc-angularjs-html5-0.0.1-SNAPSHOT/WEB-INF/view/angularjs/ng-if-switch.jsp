...
<page:angular-template>
	...
	<div ng-app="myApp">
		...
		<div ng-controller="courseController"> 
			...
			<div class="bg-success" ng-switch-when="bacom77@gmail.com">
	    		<b>ng-switch-when="bacom77@gmail.com"</b>
			</div>
			<div class="bg-success" ng-switch-when="aj.ba@outlook.com">
	    		<b>ng-switch-when="aj.ba@outlook.com"</b>
			</div>
